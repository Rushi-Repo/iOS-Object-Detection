...
export default class RightWingScreen extends Component {
  ...
  componentWillMount() {
    fetch("https://free-news.p.rapidapi.com/v1/search?q=modi||love&lang=en&page_size=20", {
	"method": "GET",
	"headers": {
          ...
          Handpicked articles for you, <Text>({this.state.index})</Text>
				...
				>
				 ...
				 <View>
					  ...
					  {isLoading ? <Animatable.View animation="fadeIn" delay={200} style={{height:'100%',width:'100%'}}><InstagramLoader active /></Animatable.View> : (
